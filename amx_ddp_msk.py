...
def download( cfg ):
    ...
    try:
        ...
        driver.find_element_by_id("edit-name").send_keys("inter")
        driver.find_element_by_id("edit-pass").click()
        driver.find_element_by_id("edit-pass").clear()
        driver.find_element_by_id("edit-pass").send_keys("partnerinter")
        driver.find_element_by_id("edit-submit").click()
        driver.find_element_by_link_text(u"Прайс-лист AMX").click()
        time.sleep(5)
